...
MACHINES = {
  ...
  :centralRouter => {
        ...
        :net => [
                   ...
                   {ip: '192.168.2.1', adapter: 6, netmask: "255.255.255.192", virtualbox__intnet: "office1"},
                   {ip: '192.168.1.1', adapter: 7, netmask: "255.255.255.128", virtualbox__intnet: "office2"},
                ]
  },
  ...
  :office1Server => {
        :box_name => "centos/7",
        :net => [
                    {ip: '192.168.2.66', adapter: 2, netmask: "255.255.255.192", virtualbox__intnet: "test-servers"},
                ]
  },
  :office2Router => {
        :box_name => "centos/7",
        :net => [
                    ...
                    {ip: '192.168.1.129', adapter: 3, netmask: "255.255.255.192", virtualbox__intnet: "test-servers"},
  ...
  :office2Server => {
        :box_name => "centos/7",
        :net => [
                    {ip: '192.168.1.130', adapter: 2, netmask: "255.255.255.192", virtualbox__intnet: "test-servers"},
                ]
  },
}
